                ...
                <div class="d-flex align-items-center py-2">
                    ...
                    <div>
                        <ul class="nav gap-3 nav-font">
                            <li class="nav-item">
                                <a class="nav-link btn-orange px-2" href="../aboutMe/index"><i class="fas fa-user"></i> Обо мне</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="card-body mx-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                        <img src="../../public/img/photo.jpg" style="width: 30%;" />
                        <img src="../../public/img/aboutMe1.jpg" style="width: 30%;" />
                        <img src="../../public/img/photo.jpg" style="width: 30%;" />
                    </div>
                    </p>
                    ...
                    <div class="d-flex justify-content-between">
                        <img src="../../public/img/photo.jpg" style="width: 30%;" />
                        <img src="../../public/img/aboutMe2.jpg" style="width: 30%;" />
                        <img src="../../public/img/photo.jpg" style="width: 30%;" />
                    </div>
                    </p>
