                ...
                <div class="d-flex align-items-center py-2">
                    ...
                    <div>
                        <ul class="nav gap-3 nav-font">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn-orange px-2" href="../education"><i class="fas fa-graduation-cap"></i> Учёба</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-color px-0" href="../historyViews"><i class="fas fa-history"></i> История</a>
                            </li>
                            <li class="nav-item">
